#!/usr/bin/env node
/**
 * Fetch coduri reducere Carturesti de pe shopilo.ro
 * Homepage: https://shopilo.ro/magazin/carturesti.ro
 */

const SHOPILO_URL = "https://shopilo.ro/magazin/carturesti.ro";
const STORE_NAME  = "Carturesti";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-ro/cod-reducere-carturesti)" }
  });
