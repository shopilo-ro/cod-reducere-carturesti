#!/usr/bin/env python3
"""
Fetch coduri de reducere Carturesti de pe shopilo.ro
Sursa: https://shopilo.ro/magazin/carturesti.ro
"""
...
SHOPILO_URL = "https://shopilo.ro/magazin/carturesti.ro"
STORE_NAME = "Carturesti"


def fetch_coupons(url=SHOPILO_URL):
    """Returneaza lista de cupoane active pentru Carturesti de pe shopilo.ro"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-ro/cod-reducere-carturesti)"
    }
    try:
